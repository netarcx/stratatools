 ...
 * Run: python3 autorefill_daemon.py [serial_port]
 */
...
void setup() {
  ...
  Serial.println("  Platform: Raspberry Pi Pico 2");
  Serial.println("=========================================");
  Serial.println();
