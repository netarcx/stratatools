...
class StratatoolsConsoleApp():
    ...
    def build_argparser(self):
        ...
        eeprom_encode.add_argument('output_file', nargs='?', type=argparse.FileType('wb'), default=sys.stdout.buffer)
        ...
        eeprom_decode.add_argument('input_file', nargs='?', type=argparse.FileType('rb'), default=sys.stdin.buffer)
